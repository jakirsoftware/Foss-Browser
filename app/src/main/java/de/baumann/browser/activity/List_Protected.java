...
public class List_Protected extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new WhitelistAdapter(this, list){
            ...
            public View getView (final int position, View convertView, @NonNull ViewGroup parent) {
                ...
                whitelist_item_cancel.setOnClickListener(v1 -> {
                    ...
                    NinjaToast.show(List_Protected.this, R.string.toast_delete_successful);
                });
                return v;
            }
        };
        ...
        button.setOnClickListener(v -> {
            ...
            if (domain.isEmpty()) {
                NinjaToast.show(List_Protected.this, R.string.toast_input_empty);
            } else if (!BrowserUnit.isURL(domain)) {
                NinjaToast.show(List_Protected.this, R.string.toast_invalid_domain);
            } else {
                ...
                if (action1.checkDomain(domain, RecordUnit.TABLE_COOKIE)) {
                    ...
                    adapter.notifyDataSetChanged();
                    NinjaToast.show(List_Protected.this, R.string.toast_add_whitelist_successful);
                }
                action1.close();
            }
        });
